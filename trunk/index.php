<?php 
$plugin_url = get_bloginfo('wpurl') . '/wp-content/plugins/wp_apptouch';
...
<link rel="stylesheet" href="<?php echo $plugin_url ?>/src/apple.css"/>
...
<script type='text/javascript' src='<?php echo $plugin_url ?>/src/zepto.min.js'></script> 
         	...
         	setTimeout(function() {
                ...
                $.each(data.posts, function(i, post) {
                    ...
                    if (post.title !== undefined) {
						...
						var post_html = '<li class="blog-content arrow"><a onTouchStart="send(' + post.id + ')" id=' + post.id + ' href="#single">';	
                        post_html += post.get_thumb;
               			post_html += '<h2>' + post.title + '</h2>';
                		post_html += '<p>' + post.excerpt + '</p></a></li>';
...
<li><a onTouchStart="send('pages')" href="#pages" class="flip"><small class="badge right">6</small><strong>Pages</strong><div class="page"></div></a></li>
...
<script type='text/javascript' src='<?php echo $plugin_url ?>/src/itabbar.js'></script>
